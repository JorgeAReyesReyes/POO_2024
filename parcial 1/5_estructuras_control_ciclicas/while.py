#EL iclo while es una Esctructura interativa que se ejecuta X veces siempre y cuando la condicion se cumpla y se sguira ejecutando tantas veces como sea true la condicion
